...
<head>
    ...
    <link href="/packages/vsch/laravel-translation-manager/css/translations.css" rel="stylesheet">{{--<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->--}}
    <!--[if lt IE 9]>
