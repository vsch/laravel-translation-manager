...
![Translation Manager Screenshot](https://raw.githubusercontent.com/vsch/laravel-translation-manager/laravel4/images/ScreenShot_main.png)
...
![Edit Pop-up Screenshot](https://raw.githubusercontent.com/vsch/laravel-translation-manager/laravel4/images/ScreenShot_edit_popup.png)
...
10. <a id="step10"></a>If you want to override the Translation Manager web interface translations or add another locale you will need to copy the language files to your project and create the Laravel 4 package override directory structure `app/lang/packages/{locale}/laravel-translation-manager/message.php` from the `vendor/vsch/laravel-translation-manager/src/lang/{locale}/message.php`

11. <a id="step11"></a>If you want to customize views for the Translation Manager web interface you will need to copy the views to your from `vendor/vsch/laravel-translation-manager/src/views` to `app/views/packages/vsch/laravel-translation-manager`

	See: [Modifying the default Views](#ModifyingViews)
...
To create your own custom version of the index.blade.php copy files as per [step 11](#step11). The package view directory also contains a `layouts/master.blade.php` file for a default layout. The intent is for you to provide your own master layout that the index.blade.php will extend so it can match your site's style.
...
- handling package translation overrides located in `app/lang/packages/{locale}/{package}`

- handling of translation files in subdirectories both the  `app/lang/{locale}/` and package override translations to allow managing package translation overrides.
